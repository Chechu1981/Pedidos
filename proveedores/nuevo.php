...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            $texto = $_POST['pedido'];
            mysql_query("INSERT INTO o_proveedores VALUES('','',NOW(),'" . strtoupper(utf8_decode($_POST['proveedor'])) . "','" . strtoupper(utf8_decode($_POST['operario'])) . "','" . strtoupper(utf8_decode($_POST['orden'])) . "','" . strtoupper(utf8_decode($_POST['comentario'])) . "','" . strtoupper(saltoLinea(utf8_decode($texto))) . "','');");
