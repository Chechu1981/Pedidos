...
$result= $mysqli->query("SELECT * FROM o_proveedores WHERE fecha_recibido LIKE '%0000%' ORDER BY fecha_pedido DESC;");
?>
<div style="clear: both"></div>
<table border="1" class="listado">
    <th style="width: 10px"><b style="font-size: large"><?php echo $result->num_rows; ?></b></th><th>Fecha de pedido</th><th>Proveedor</th><th>Operario</th><th>Orden/Cliente</th><th>Comentario</th><th>Pedido</th><th>Recibido</th><th></th><th></th>
<?php
