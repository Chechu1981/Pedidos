...
$result=mysql_query("SELECT * FROM o_proveedores  WHERE proveedor LIKE '%".$_GET['prove']."%'AND pedido LIKE '%".$_GET['pedido']."%' AND orden LIKE '%".$_GET['ord']."%' AND operario LIKE '%".$_GET['operario']."%' AND comentario LIKE '%".$_GET['comentario']."%' ORDER BY fecha_recibido DESC;");
