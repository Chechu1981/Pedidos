...
<html>
	...
	<div class="contenedor">
        ...
        <div class="principal">
            ...
            ?>
        <div class="banda">
            <img src="../imagenes/logo_volvo.png" width="50" style="float: left;margin: 8px" />
            <h2 style="padding:15px;color:blue;">Pendiente de Servir</h2>
        </div>  
        <div>
            <table border='2' width='100%;' class='volvolinea'>
                ...
                <?php 
                    ...
                    while($fila=mysql_fetch_row($sentencia)){
                        ...
                        echo "<td><a href='pedidosv.php?ano=".$anio."&mes=".$ms."&numes=".$n."&dia=".$dy."&ref=".$fila[1]."'>".$fila[10]."</a></td></tr>";
                        if($contador==51){
                            return;
                        }
