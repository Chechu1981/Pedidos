    ...
    <body onload="document.getElementById('ref').focus()" >
        <div class="contenedor">
            ...
            <div class="principal">
                ...
                <?php
                $sentencia = $mysqli->query("SELECT * FROM listasemanal ORDER BY numero DESC;");
                $nlineas = $mysqli->query("SELECT COUNT(id) FROM SEMANAL GROUP BY pedido WHERE PEDIDO = ;");
                ?>
                <hr/>
                <div>
                    <table border='2' width='780px;' class='semanal'>
                        ...
                        <?php 
                            ...
                            $nlineas = $mysqli->query("SELECT COUNT(id),pedido FROM SEMANAL WHERE pedido = ".$fila[0]." GROUP BY pedido;");
                        ...
                        if (utf8_encode($fila[1]) == 'En curso') {
                                ...
                                ?> <a href="semanal.php?pedido=<?php echo utf8_encode($fila[0]); ?>" ><?php echo utf8_encode($fila[2]); ?></a> <?php
                            }
                            ?>
                                </td>
                            </tr>
