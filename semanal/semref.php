...
<html>
    <head>
        ...
        $mysqli->query("INSERT INTO semanal 
    ...
    $(function() {
        $("#fecha").datepicker({
            ...
            monthNames: ["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"]
                ...
                $fechasemanal = $mysqli->query("SELECT * FROM listasemanal WHERE numero LIKE '" . $pedido . "';");
                if (isset($_GET['pedido'])) {
                    if ($pedido > 1) {
                        ?>
                ...
                <div id="tbl">
                    <table border='2' width='780px;' class='semanal'>
                        <tr><th></th><th><a href="semref.php?encurso=<?php echo $_GET['encurso']; ?>&pedido=<?php echo $pedido; ?>" ><b>Referencia</b></a></th><th style="width: 18px">C</th><th>Denominaci&oacute;n</th><th>Matr&iacute;cula/Comentario</th><th><a href="semcli.php?encurso=<?php echo $_GET['encurso']; ?>&pedido=<?php echo $pedido; ?>" >Cliente/OR</a></th><th><a href="semanal.php?encurso=<?php echo $_GET['encurso']; ?>&pedido=<?php echo $pedido; ?>">Fecha</a></th><th></th></tr>
                        <?php 
                        $sentencia = $mysqli->query("SELECT * FROM semanal WHERE pedido LIKE '" . $pedido . "' ORDER BY referencia ASC,cliente,referencia ;");
