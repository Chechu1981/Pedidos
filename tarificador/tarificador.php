...
<html>
    <head>
        ...
        $nombres = mysql_query("SELECT cadena FROM nombres WHERE aplicacion = 'tarificador'");
        while ($tarificador = mysql_fetch_row($nombres))
            $linea = $tarificador[0];
        ?>
        ...
        <div class="contenedor">
            ...
            <div class="principal">
                <div class="banda">
                    ...
                    <br/><br/><br/>Última atualización: Octubre 2014
                </div>
            </div>
                ...
                <form>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="marca" onchange="enviarc()" style="width:160px;" >
