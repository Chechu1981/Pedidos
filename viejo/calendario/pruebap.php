...
setInterval( function() {
	...
	$("#hours").html(( hours < 10 ? "0" : "" ) + hours);
       ...
       var tabla=ajax.XMLHttpRequest();
       function enviar(){
		ajax.open('GET','tabla.php?numes=<?php echo calcular_numes(); ?>&dia=<?php echo calcular_dia(); ?>&mes=<?php echo calcular_mes(); ?>&ano=<?php echo calcular_ano();?>',true);
		ajax.send(null);
    ...
    <body onload="javascript:foco();cargar();enviar()">
        <div id="tb"></div>
