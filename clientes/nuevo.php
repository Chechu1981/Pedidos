...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <?php
            if (isset($_POST['new'])) {
                $exist = $mysqli->query("SELECT * FROM hoja1 WHERE Nombre LIKE '" . $_POST['nombre'] . "'");
                $con = $exist->fetch_row();
                echo $con[0];
                if ($con[0] != "" or $_POST['nombre'] == '') {
                    ...
                    $mysqli->query("INSERT INTO hoja1 VALUES('" . utf8_decode($_POST['cod']) . "','" . utf8_decode($_POST['nombre']) . "','" . utf8_decode($_POST['den']) . "','" . utf8_decode($_POST['tele']) . "','" . utf8_decode($_POST['fax']) . "','" . utf8_decode($_POST['con']) . "','" . utf8_decode($_POST['pob']) . "','" . utf8_decode($_POST['hor']) . "','" . utf8_decode($_POST['mail']) . "','','" . utf8_decode($_POST['tipo']) . "'," . $ruta . ");");
