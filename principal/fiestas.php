...
<html>
    <head>
        ...
        if (isset($_POST['mes'])) {
            mysql_query("INSERT INTO fiestas (dia,mes,nombre)VALUES('" . $_POST['dia'] . "','" . $_POST['mes'] . "','" . utf8_decode($_POST['nombre']) . "')");
        }
        $fechas = mysql_query("SELECT * FROM fiestas ORDER BY mes, dia ASC");
        ?>
                        ...
                        <tr>
                            ...
                            <td rowspan="4" >
                                <div id="actuales">
                                    <table>
                                        <?php
                                        while ($campo = mysql_fetch_row($fechas)) {
                                            ?>
                                            <tr>
