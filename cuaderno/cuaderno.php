...
<html>
    <head>
        ...
        if (isset($_POST['incluir']) & @$_POST['cli'] != '') {
            ...
            $mysqli->query("INSERT INTO cuaderno 
...
?>
                ...
                <div class="banda">
                    <h2 style="padding:15px;" id="titulo">Cuaderno de pedidos. Chechu</h2>
        ...
        <div id="tbl">
            <table border='2' width='780px' class='cuadernoTbl' style="margin:auto">
                        ...
                        <?php
                        $sentencia = $mysqli->query("SELECT * FROM `cuaderno` WHERE date_format(fecha,'%d-%c-%Y') = date_format(now(),'%d-%c-%Y') AND operario LIKE 'CHECHU' ORDER BY fecha DESC,cliente,referencia ;");
