...
<html>
    <head>
        ...
        <script src="funcionesJ.js" type="text/javascript" ></script>
...
?>
                ...
                <div class="banda">
                    <h2 style="padding:15px;" id="titulo">Cuaderno de pedidos. Javi</h2>
        ...
        <div id="tbl">
            <table border='2' width='780px' class='cuadernoTbl' style="margin:auto">
                        ...
                        <?php
                        $sentencia = mysql_query("SELECT * FROM `cuaderno` WHERE date_format(fecha,'%d-%c-%Y') = date_format(now(),'%d-%c-%Y') AND operario LIKE 'JAVI' ORDER BY fecha DESC,cliente,referencia ;");
