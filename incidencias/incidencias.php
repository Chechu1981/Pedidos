    ...
    <body onload="cargar()">
        <div class="contenedor">
            ...
            if (isset($_POST['ref'])) {
                $designacion = "";
                $ubicacion = "";
                $sentencia = mysql_query("SELECT * FROM denominacion WHERE referencia LIKE '" . $_POST['ref'] . "'");
                ...
                mysql_query("INSERT INTO incidencias (referencia,designacion,ubicacion,comentario,hay,marca,fecha) VALUES ('" . $_POST['ref'] . "','" . $designacion . "','" . $ubicacion . "','" . $_POST['comentario'] . "','" . $_POST['hay'] . "','" . $_POST['marca'] . "',NOW())");
            }
