        ...
        if (isset($_POST['precio'])) {
            if ($_POST['precio'] != "" and $_POST['dto'] != "") {
                ...
                if (is_numeric($pvp) and is_numeric($dto) and is_numeric($portes)) {
                    ...
                    echo "<div style='margin-left:15px'>Precio: " . str_replace(".", ",", $pvp) . " € <br/>Descuento: " . str_replace(".", ",", $dto) . " % <br/>Neto: " . str_replace(".", ",", number_format($pvp - ($dto / 100) * $pvp,2)) . " €<br/>Portes: " . str_replace(".", ",", $portes) . " €</div>";
                } else {
                    $es_numero = false;
