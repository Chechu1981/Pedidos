    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function enviarConsulta() {
                ...
                actualizarCantidad.open("GET", "insertarRuta.php?cod=" + cod + "&ordenante=" + ordenante + "&prio=" + prio + "&comentario=" + comentario, true);
        ...
        <form method="POST" action="dialogoNuevoCliente.php" style="text-align:center" onsubmit="enviarConsulta()" >
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <select id="empleado" onkeyup="envioConIntro(event)">
                            <option></option>
                            <?php
...
<?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <select id="prio" onkeyup="envioConIntro(event)">
