...
mysql_query("INSERT INTO ruta (id,ordenante,fechaPedido,cliente,direccion,comentario,prioridad,entregado)VALUES('','" . utf8_decode($ordenante) . "',NOW(),'" . $destino . " (" . $cliente[0] . ")','" . $cliente[6] . "','" . utf8_decode($comentario) . "','" . $prio . "','EN CURSO')");
