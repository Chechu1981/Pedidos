...
<ul id="nav">
    ...
    <li><a href="#">Cuaderno</a><ul>
            <li><a href="../cuaderno/cuaderno.php">Chechu</a></li>
            <li><a href="../cuaderno/cuadernoJavi.php">Javi</a></li>
            <li><a href="../cuaderno/cuadernoCesar.php">César</a></li>
        </ul></li>
    <?php } ?>
    ...
    if ($_SERVER['REMOTE_USER'] == "medina") {
        ?><li><a href="../proveedores/proveedores.php" >Otros proveedores</a></li><li><a href="../../semanal/semanal.php?encurso=SI">Semanal</a></li>
<li><a href="#">Otros</a>
                    <ul>
                        <li><a href="../cambio/cambio.php">Cambio</a></li>
                        <li><a href="../ubicacion/consulta.php">Consulta</a></li>
